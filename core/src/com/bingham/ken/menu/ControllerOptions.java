 ...
 */
public class ControllerOptions extends MenuItem {
    ...
    public ControllerOptions(OrthoCamera camera, Sprite sprite, Vector2 pos, Vector2 scale, GamePreferences prefs) {

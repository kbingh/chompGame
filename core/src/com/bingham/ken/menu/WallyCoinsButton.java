 ...
 */
public class WallyCoinsButton extends MenuItem {
    ...
    public WallyCoinsButton(OrthoCamera camera, Sprite sprite, Vector2 pos, Vector2 scale, GamePreferences prefs) {
...
//sprite has been clicked
    ...
    public void start(){
      ...
      prefs.setGameState(EntityManager.WALLYCOINS);

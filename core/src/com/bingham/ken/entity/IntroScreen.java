 ...
 */
public class IntroScreen extends MenuItem {
    ...
    public IntroScreen(OrthoCamera camera, GamePreferences prefs) {
		super(SpriteCache.CREDITSINTRO, new Vector2(0,0), new Vector2(1f,1f));
    ...
    public void intro(){
       ...
       prefs.setGameState(EntityManager.INTRO);
